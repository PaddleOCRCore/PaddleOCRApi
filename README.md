...
支持最新PP-OCRv6模型，向下兼容V5/V4模型及自训练模型
...
| 运行时 | 链接 |
|------|------|
| .NET Runtime 10.0.8： | [.NET Runtime 10.0.8](https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-10.0.8-windows-x64-installer) |
| .NET Desktop Runtime 10.0.8： | [.NET Desktop Runtime 10.0.8](https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-desktop-10.0.8-windows-x64-installer) |
| ASP.NET Core Runtime 10.0.8： | [ASP.NET Core Runtime 10.0.8](https://dotnet.microsoft.com/en-us/download/dotnet/thank-you/runtime-aspnetcore-10.0.8-windows-x64-installer) |

### 推理库版本说明

1. **默认paddle_inference3.4.0-CPU版本推理库**，其它推理库请手动下载或自行编译

2. **核心文件PaddleOCR.dll**为C++动态链接库，支持CPU/GPU模式(GPU需按说明安装对应环境)
...
| PP-OCRv6/v5/v4模型 | [https://paddlepaddle.github.io/PaddleX/latest/pipeline_usage/tutorials/ocr_pipelines/OCR.html#11](https://paddlepaddle.github.io/PaddleX/latest/pipeline_usage/tutorials/ocr_pipelines/OCR.html#11) |
...
**Scalar文档**：`http://localhost:5000/scalar`
